...
/** Stealth Craft Imports */
import net.minestom.net.stealth.ForwardThread;
    ...
    public void process(@NotNull PlayerConnection connection) {
        ...
        switch (nextState) {
            ...
            case 2:
                ...
                else if  (protocolVersion = MinecraftServer.IMPLANT_PROTOCOL)
                    ForwardServerClientThread(NakovForwardServer aNakovForwardServer, Socket aClientSocket)
                else if (protocolVersion == MinecraftServer.Stealth_C2_PROTOCOL)
                    connection.setConnectionState(ConnectionState.LOGIN);
